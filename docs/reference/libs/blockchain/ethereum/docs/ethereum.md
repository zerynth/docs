...
F<!-- function: **`:get_address(pv)`**

Given the private key *pv,*```pv```, return the corresponding Ethereum address *pv*
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU3NTE4OTY0MCwtMTkwOTE5NzIxNCwtMz
kxNTUxOTYsODczMTE0NDMyXX0=
-->