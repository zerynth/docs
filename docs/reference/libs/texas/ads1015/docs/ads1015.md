...
!!!abstract "`#!py3 ADS1015(i2cdrv, addr = 0x48, clk = 100000)`"
...
!!!abstract "`#!py3 set(os = 0, ch = 4, pga = 2, mode = 0, sps = 4, cmode = 0, cpol = 0, clat = 0, cque = 3)`"
...
!!!abstract "`#!py3 set_threshold(low, high)`"
