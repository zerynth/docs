...
interfaces, the present library enables I2C only ([datasheet](https://ae-bst.resource.bosch.com/media/_tech/media/datasheets/BST-BME280_DS001-11.pdf)).
...
!!!abstract "`#!py3 BME280(drvname, addr=0x76, clk=400000)`**"
...
!!!abstract "`#!py3 setup(mode = 3, os_t = 1, os_h = 1, os_p = 1, t_sb = 6, filter = 1)`**"
...
!!!abstract "`#!py3 get_chip_id()`"

Return the device chip id as a single byte integer.
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE3Mjc4MTMyMiwxOTU2NzgzODY0LDE4OD
kyNjU3NThdfQ==
-->