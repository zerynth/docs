...
!!!abstract "`#!py3 SW01(drvname, addr=0x76, clk=100000)`"
...
| 3
    ...
    |
```NOTE```: See pages 12-13 of the 

```
datasheet_
```

 for more details on operating mode and allowed sensor mode transitions.
