...
*	**
    ...
    * ```range**``` – Full-scale range: *```HIGH*``` (0-36V) or *LOW*```LOW``` (0-5V)
...
RleHQiOiIqKmByZWFkTWFpblZvbHRhZ2UoKWAqKiIsInN0YXJ0
Ijo1ODUzLCJlbmQiOjU5MzJ9fSwiY29tbWVudHMiOnsiTXNOTV
...
LCJoaXN0b3J5IjpbNjc5MTIwNjk1LDEzODkzOTA3MzIsNzY5OT
g0ODU2XX0=
-->