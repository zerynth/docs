...
* **num**    * ```num``` – 0 to set mask 0 on RX buffer, 1 to set mask 1 on RX buffer
* **
...
* **num**    * ```num``` – number of filter to be set in RX buffer (from 0 to 5)
* **
...
Returns canid, msg.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY1NzAyNDY4MV19
-->