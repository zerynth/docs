...
-	**tempkey_as_first_block** (*bool*) – If False Slot<strong text> in first SHA block is used, otherwise TempKey is.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU1NzYxMjA1OSw2OTU1NjQwMzYsMjExNz
