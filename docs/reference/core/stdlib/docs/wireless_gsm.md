...
!!!abstract "`#!py3 attach(apn, username = "", psw = "", auth = AUTH_NONE, timeout=120000)`"
...
!!!abstract "`#!py3 set_operator(opname)`"
...
!!!abstract "`#!py3 set_rat(rat, bands=[])`"
...
!!!abstract "`#!py3 list_sms(unread=False, maxsms=10, offset=0)`"
