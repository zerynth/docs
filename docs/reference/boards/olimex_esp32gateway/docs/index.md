...
```NOTE```: Drivers for the CH340 Module can be downloaded [here](https://www.olimex.com/Products/IoT/ESP32-GATEWAY/open-source-hardware)  in “Software” section and are needed for **Windows and Mac platforms**. In Linux systems, the Olimex Esp32 Gateway should work out of the box.
