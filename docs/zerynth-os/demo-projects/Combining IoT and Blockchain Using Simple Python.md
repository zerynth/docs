...
For better understand the advantages of using Blockchain with Embedded Systems, take a look at this tech talk by [BARR Group](https://barrgroup.com/tech-talks).

And here you can find the [use case for logistics made by TOI – Things on Internet](https://www.zerynth.com/use-cases/blockchain-enabled-iot-shipment-tracking-system/), the company that develops 4ZeroBox, an ESP32 board “powered by Zerynth” and tailored for Industrial IoT applications.
...
For more info take a look at the [official documentation page](https://docs.zerynth.com/latest/reference/libs/blockchain/ethereum/docs/). You can also find the source code of the library on [GitHub](https://github.com/zerynth/lib-blockchain-ethereum)!
...
Take a look at a snippet of the code. You can find the complete code and more info at the related [documentation page](https://docs.zerynth.com/latest/reference/libs/blockchain/ethereum/docs/examples/#simple-transaction).
...
From **Zerynth Studio**, after uplinked the project to your microcontroller, [open the serial monitor](https://docs.zerynth.com/latest/#device-management-widget) to check the progress of the execution.
...
We hope that you enjoyed the whole tutorial, even if you didn’t win in the Dice Game. [Download Zerynth Studio](https://www.zerynth.com/zsdk/), and start combining IoT and Blockchain with our Python tools.
